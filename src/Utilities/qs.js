 ...
 * @param {object} default params that are not handled with search (page/offset, page_size/limit and order_by/sort_by)
...
export function getQSConfig(
  ...
  if (typeof defaultParams.sort_by === undefined) {
    defaultParams.sort_by = 'name:desc';
    defaultParams.sort_order = 'desc';
    defaultParams.sort_options = 'name';
  }
  return {
    namespace,
    defaultParams,
